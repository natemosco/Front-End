...
function App() {
	...
	return (
		<div className="App">
			...
			<Route path="/export-to-spotify" render={(props) => <ProtectedExportToSpotify  {...props} setSongs={setSongs} recommendedIsChecked={recommendedIsChecked} setRecommendedIsChecked={setRecommendedIsChecked} setRecs={setRecs} setMainGraphUrl={setMainGraphUrl} />}></Route>
		</div>
	);
}
